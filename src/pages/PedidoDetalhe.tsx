...
/* PipelinesPanel removido — substituído por ArquivosProjetoPanel. Kanbans seguem nas telas próprias. */
...
function PedidoHeaderPanel({ pedido, orcamento, cliente, loja, contrato, vendedor, responsavel, adendos, usuarios = [], salvarPedido, prazoConfig }: any) {
  ...
  const ETAPA_COLOR: Record<string, string> = {
    contrato_nao_assinado: "bg-rose-100 text-rose-700",
    ...
    vistoria_finalizacao: "bg-purple-100 text-purple-700",
