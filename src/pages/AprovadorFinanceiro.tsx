...
import { ArrowLeft, ShieldCheck, Check, X, AlertTriangle, ArrowDownCircle, ArrowUpCircle } from "lucide-react";
          ...
          <table className="w-full text-sm">
            <thead>
              <tr className="text-[10px] uppercase tracking-wider text-muted-foreground border-b bg-muted/30">
                <th className="text-left py-3 px-5 font-medium">Lançado em</th>
              ...
              {lista.map((l) => {
                ...
                return (
                  <tr key={l.id} className="border-b hover:bg-muted/30">
                    <td className="py-3 px-5 whitespace-nowrap text-xs text-muted-foreground">
