...
const moreGroups: Group[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { label: "Categorias Financeiras", path: "/categorias-financeiras", icon: Folder, modulo: "categorias_financeiras" },
      { label: "Centros de Custo", path: "/centros-custo", icon: Folder, modulo: "centros_custo" },
    ],
  },
  {
    label: "Sistema",
