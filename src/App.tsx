...
const UsuariosSistemaSaaS = lazy(() => import("@/pages/sistema-saas/UsuariosSistema"));
...
const ContratoSaaSAssinar = lazy(() => import("@/pages/ContratoSaaSAssinar"));
        ...
        <ErrorBoundary>
          <AuthProvider>
            ...
            <Routes>
              ...
              <Route path="/contrato-saas/:token" element={<ContratoSaaSAssinar />} />
              ...
              <Route element={<ProtectedRoutes />}>
                ...
                <Route path="/financeiro/checagem-contratos" element={<RequirePermission modulo="checagem_contratos"><ChecagemContratos /></RequirePermission>} />
                ...
                <Route path="/sistema-saas/usuarios" element={<RequirePermission modulo="sistema.usuarios_saas"><UsuariosSistemaSaaS /></RequirePermission>} />
